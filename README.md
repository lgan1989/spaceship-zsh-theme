...
```
curl -o - https://raw.githubusercontent.com/lgan1989/spaceship-zsh-theme/master/install.sh | zsh
```

Installing using **wget**:

```
wget -O - https://raw.githubusercontent.com/lgan1989/spaceship-zsh-theme/master/install.sh | zsh
```
